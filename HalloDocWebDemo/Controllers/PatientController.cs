...
namespace HalloDocWebDemo.Controllers
{
    public class PatientController : Controller
    {
        ...
        [HttpPost]
        public IActionResult DocumentUpload(ViewDocument model , int id)
        {
            _PatientRequestService.Documentupload(model, id);
            return RedirectToAction("ViewDocument", new {id});
        }
